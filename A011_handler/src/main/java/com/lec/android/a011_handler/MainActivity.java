...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thread1.setDaemon(true); //메인 스레드의 종료 동기화.
    ...
    public void mOnClick(View v){
        ...
        tvBackValue1.setText("작업1스레드 값 : " + backValue1);
        tvBackValue2.setText("작업1스레드 값 : " + backValue2);
    }// end mOnClick()
