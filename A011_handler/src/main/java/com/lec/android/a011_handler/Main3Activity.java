    ...
    */
    ...
    public void mOnClick2(View v){
        new AlertDialog.Builder(this)
                ...
                .setNegativeButton("아니용",null)
                .show();
    }

    //#3 ) View 에 Runnable 을 담아서 보냄 : Handler 가 필요없음
    public void mOnClick3(View v){
        new AlertDialog.Builder(this)
                .setTitle("질문3")
                .setMessage("업로드 하시겠습니까?")
                .setPositiveButton("네에", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void mOnClick4(View v){
        new AlertDialog.Builder(this)
                .setTitle("질문4")
                .setMessage("업로드 하까뇽?")
                .setPositiveButton("녜!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        timer.schedule(task,3000); // 134의 task를 3초뒤에 업로드 해라
                    }
                })
                .setNegativeButton("아녀!",null)
                .show();
    }
