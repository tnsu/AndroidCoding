...
// Value1
// 1~10 초까지 단위로 증가시키키
//10초 도달하면 멈추어서 Toast 띄우기
// Message 사용
// Value2
// 1~20 초까지 단위로 증가시키키
//20초 도달하면 멈추어서 Toast 띄우기
// Handler 사용
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHandler3 = new Handler(){
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                if (value3 < 5){
                    ...
                    Toast.makeText(getApplicationContext(),"3종료",Toast.LENGTH_LONG).show();
                }
            }
        };
        mHandler3.sendEmptyMessage(0); // 핸들러 만들고 곧바로 시작
        ...
        new CountDownTimer(15*1000, 1000){
            ...
            public void onFinish() { // 종료시 수행하는 코드
                Toast.makeText(getApplicationContext(),"4 종료",Toast.LENGTH_LONG).show();
            }
        }.start(); // 타이머 시작 내부적으로스레드씀
