...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            e.printStackTrace();
            Log.e("myapp", "데이터베이스를 열수 없음"); // logcat 의 error 에 표시됨
        }
    ...
    void insert(String name, int age, String address){
        ...
        Log.d("myapp", result+ "q번쨰 개 row INSERT 성공");
        tvResult.setText(result+ "개 row q번째INSERT 성공");
        select();
    };
    ...
    // 특정 name 값을 가진 레코드(를) 삭제
    void delete(String name){
        int cnt = db.delete(tableName, // 데이블명
                "name=?", // WHERE 조건절
