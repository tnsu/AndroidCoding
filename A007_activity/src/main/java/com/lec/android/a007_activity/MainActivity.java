...
public class MainActivity extends AppCompatActivity {
    ...
    // 다른 액티비티가 보여질 때 (혹은 다른 액티비티에 의해 가려지기 시작할때) 호출
    ...
    // 직전에 저장되어있던 액티비티의 상태정보가 있다면
    // onRestoreInstanceState() 는 onStart 진적에 호출됨
    @Override
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            tvResult.setText(savedInstanceState.getString("value")); // 저장된 키값과 동일해야 값을 가져올 수 있음
        }
    }

    // 액티비티 소멸 전에 호출 된다. (주의! onPause 뒤에 호출된다고 간주하지 말것)
    // outState : 액티비티 정보저장(백업) 하여 나중애 onCreate 에서 사용 가능
    @Override
