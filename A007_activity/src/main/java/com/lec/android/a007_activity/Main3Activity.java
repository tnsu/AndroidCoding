...
public class Main3Activity extends AppCompatActivity {
    ...
    private final int REQUSET_CODE_CALC = 1011;
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  startActivity(intent);
                ...
                // 값을 돌려받기 위한 화면 전환
                startActivityForResult(intent,REQUSET_CODE_CALC);
            }
        });

    }// end onCreate

    // startActivityForResult() 로 넘어갔던 화면으로부터 결과값을 돌려받으면 호출되는 메소드드
    @Override
