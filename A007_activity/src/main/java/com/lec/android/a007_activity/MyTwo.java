...
public class MyTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setText("인텐트 받은값 : " + a + " : " + b + " : " + c + " : " + l + " : " + msg);

        // Person 데이터 받기
        Person p = (Person)intent.getSerializableExtra("Person"); // 형변환해주기

        TextView tv2 = findViewById(R.id.tv2);
        tv2.setText("Person 의 받은 값 : " + p.getName() + " : " + p.getAge());
