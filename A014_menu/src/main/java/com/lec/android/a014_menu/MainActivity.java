...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.manu_main1,menu); // menu 리소스(xml) 로부터 Menu 생성
        Log.d("myapp","onCreateOptionsMenu] 최초 메뉴키를 눌렀을 때 호출됨");

        //#2 심지어 MenuItem 을 동적으로 추가가능하다
        // add(), MenuItem 리턴
    ...
    public void showInfo(MenuItem item){
        ...
        Log.d("myapp", msg);
        Toast.makeText(this, title+"메뉴 클릭", Toast.LENGTH_LONG).show();
